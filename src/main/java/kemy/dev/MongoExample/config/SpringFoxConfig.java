    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .build().apiInfo(new ApiInfo(
                        "MongoDB Swagger example",//  title
                        " swagger Api for MongoDB Project  ", //   description
                        "1.0.0",// version
                        " https://it.wikipedia.org/wiki/Licenza_MIT",//termsOfServiceUrl
                        new Contact("Kemonia","https://github.com/Mayakem76/MongoExample1","kemonia_j@yahoo.it"),//Contact contact
                        "MIT",//license
